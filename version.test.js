...
test("全ローカルCSS・JavaScriptを0.5.0のキャッシュ識別子で読み込む", () => {
  ...
  assert.match(html, /style\.css\?v=0\.5\.0-100/);
  assert.match(html, /chart-block-utils\.js\?v=0\.5\.0-13/);
  ...
  assert.match(html, /app\.js\?v=0\.5\.0-161/);
});
