...
test("タグ関連スクリプトのキャッシュ番号を更新する", () => {
  assert.match(html, /href="style\.css\?v=0\.5\.0-72"/);
  ...
  assert.match(html, /src="app\.js\?v=0\.5\.0-133"/);
  assert.ok(html.indexOf('src="tags.js?v=0.5.0-4"') < html.indexOf('src="memo-list-utils.js?v=0.5.0-5"'));
  assert.ok(html.indexOf('src="memo-list-utils.js?v=0.5.0-5"') < html.indexOf('src="app.js?v=0.5.0-133"'));
});
