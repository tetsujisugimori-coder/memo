...
test("設定UIは明示保存・個別設定・比較・受取確認を持つ", () => {
  ...
  assert.ok(html.indexOf('font-recommendation.js?v=0.5.0-1') < html.indexOf('app.js?v=0.5.0-95'));
  assert.ok(html.indexOf('web-font-loader.js?v=0.5.0-2') < html.indexOf('app.js?v=0.5.0-95'));
